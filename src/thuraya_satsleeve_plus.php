...
<html lang="ru">
  <head>
    <meta charset="utf-8">
    <title>Спутниковый телефон Thuraya SatSleeve +</title>
        ...
        <div class="wrapper">
          ...
          <div class="page-item">
            <div class="page-item__top">
              <div class="page-item__top-left">
                ...
                <div class="page-item__image-small">
                  <div class="page-item__image-small-item  page-item__image-small-item--1">   <img class="item-img-small1" src="img/thuraya-satsleeve-smartphone-satellite-adaptor-282642.jpg">
                  </div>
                  <div class="page-item__image-small-item  page-item__image-small-item--2">   <img class="item-img-small2" src="img/Thuraya-SatSleeve-.media.01.jpg">
                  </div>
                  <div class="page-item__image-small-item  page-item__image-small-item--3">   <img class="item-img-small3" src="img/Thuraya_SatSleeve_Plus.jpg">
                  </div>
                </div>
              </div>
              <div class="page-item__top-right">
                <h3 class="page-item__title-category">Спутниковые телефоны Thuraya</h3>
                <h2 class="page-item__title">SatSleeve +</h2>
                <p class="page-item__description">Thuraya SatSleeve + - это универсальное устройство, которое позволит пользоваться Вашим смартфоном в спутниковом режиме, будь-то iPhone или Android.</p>
            ...
            <div class="page-item__info">
              <p>Данное устройство это продолжение линейки SatSleeve, теперь нет необходимости приобретать отдельную приставку под разные модели смартфонов. Устройство стало универсальным, просто вставьте телефон в переходник и зафиксируйте его с двух сторон специальным зажимом.</p>
              <p>C SatSleeve + Вы сможете совершать голосовые вызовы, отправлять смс сообщения, пользоваться электронной почтой, приложениями WhatsApp, Viber и т.д.</p>
              <p>Thuraya SatSleeve + имеет программируемую кнопку SOS, она позволяет в случае чрезвычайной ситуации максимально быстро отправить Ваши координаты и совершить звонок на заранее прописанный номер не подключая смартфон к устройству.</p>
              <p><b>Чтобы использовать SatSleeve + необходимо:</b></p>
              <ol>
                <li>Установить sim-карту оператора Thyraya в устройство. </li>
                <li>Скачать бесплатно одноименное приложение в AppStore или Google play.</li>
                <li>По средствам Wi-fi соединить Ваш смартфон и SatSleeve. </li>
              </ol>
              <p>После, Вы сможете использовать устройство в зоне покрытия Thuraya. </p>
            </div>
          </div>
        </div>
      </div>
