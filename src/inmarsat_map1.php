...
<html lang="ru">
  <head>
    <meta charset="utf-8">
    <title>Карта покрытия Инмарсат BGAN</title>
        ...
        <div class="wrapper">
          <div class="page-main__top">
            <div class="breadcrumbs">
              ...
              <span>>></span>
              <a>Карта покрытия Инмарсат BGAN</a>
            </div>
            <div class="cart">
          ...
          <div class="catalog">
            <h2 class="h2-title  h2-title--in"><a>Карта покрытия Инмарсат BGAN</a></h2>
            <div class="article">
              <p><img src="http://www.tecckom.ru/photos/map1_1.gif"></p>
              <p><img src="http://www.tecckom.ru/photos/map2_1.gif">Спутник I-4 Америка,   <img src="http://www.tecckom.ru/photos/map4_1.gif">Спутник I-4 Европа, Средний восток, Азия, <img src="http://www.tecckom.ru/photos/map3_1.gif"> Спутник I-4 Азия, Тихий океан</p>
            </div>
          </div>
        </div>
      </div>
