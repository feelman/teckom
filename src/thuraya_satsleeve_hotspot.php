...
<html lang="ru">
  <head>
    <meta charset="utf-8">
    <title>Спутниковый телефон Thuraya SatSleeve Hotspot</title>
        ...
        <div class="wrapper">
          ...
          <div class="page-item">
            <div class="page-item__top">
              <div class="page-item__top-left">
                <div class="page-item__image-big">
                  <img class="item-img-big" src="img/hotspot.jpg">
                </div>
                <div class="page-item__image-small">
                  <div class="page-item__image-small-item  page-item__image-small-item--1">   <img class="item-img-small1" src="img/hotspot.jpg">
                  </div>
                  <div class="page-item__image-small-item  page-item__image-small-item--2">   <img class="item-img-small2" src="img/hotspot2.jpg">
                  </div>
                  <div class="page-item__image-small-item  page-item__image-small-item--3">   <img class="item-img-small3" src="img/hotspot3.png">
                  </div>
                </div>
              </div>
            ...
            <div class="page-item__info">
              <p>Данное устройство позволит быть более мобильным, установив Thuraya SatSleeve Hotspot на улице, Вы можете находиться в помещении и использовать весь функционал устройства с помощью своего телефона. Сопряжение Thuraya SatSleeve Hotspot и смартфона происходят по средствам Wi-fi.</p>
              <p>Thuraya SatSleeve Hotspot имеет программируемую кнопку SOS, она позволяет в случае чрезвычайной ситуации максимально быстро отправить Ваши координаты и совершить звонок на заранее прописанный номер не подключая смартфон к устройству.</p>
              <p><b>Чтобы использовать SatSleeve Hotspot необходимо:</b></p>
              <ol>
