...
<html lang="ru">
  <head>
    <meta charset="utf-8">
    <title>Спутниковая связь Globalstar</title>
        ...
        <div class="wrapper">
          <div class="page-main__top">
            <div class="breadcrumbs">
              ...
              <span>>></span>
              <a>Телефоны спутниковой связи Globalstar</a>
            </div>
            <div class="cart">
          ...
          <div class="catalog">
            <h2 class="h2-title  h2-title--in"><a>Спутниковая связь Globalstar</a></h2>
            <div class="catalog__list">
              ...
              <div class="catalog__list-top-descr"><p>Система Глобалстар изначально формировалась как система, предназначенная для взаимодействия с существующими сотовыми сетями, дополняя и расширяя их возможности за счет осуществления связи за пределами зон покрытия, а также для стационарной связи в удаленных районах, где создание сотовой инфраструктуры либо инфраструктуры сети общего пользования по экономическим либо технологическим причинам нецелесообразно. </p></div>
