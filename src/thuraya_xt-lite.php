...
<html lang="ru">
  <head>
    <meta charset="utf-8">
    <title>Спутниковый телефон Thuraya XT-lite</title>
        ...
        <div class="wrapper">
          ...
          <div class="page-item">
            <div class="page-item__top">
              <div class="page-item__top-left">
                <div class="page-item__image-big">
                  <img class="item-img-big" src="img/thuraya-xt-lite.jpg">
                </div>
              ...
              <div class="page-item__top-right">
                ...
                <h2 class="page-item__title">Thuraya XT-lite</h2>
                <p class="page-item__description">Представляем Thuraya XT-LITE. Оптимальное решение для спутниковой связи.</p>
                <div class="page-item__buy">
                  <div class="page-item__buy-price">34 990Р</div>
            ...
            <div class="page-item__info">
              <p>Thuraya XT-LITE это бюджетная модель спутникового телефона, с помощью которого Вы можете совершать звонки и отправлять СМС-сообщения в спутниковом режиме. С XT-LITE Вы обеспечите себе надежную и высококачественную связь в более чем 160 странах мира. </p>
            </div>
          </div>
        </div>
      </div>
