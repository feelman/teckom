...
<html lang="ru">
  <head>
    <meta charset="utf-8">
    <title>Спутниковый телефон Telit SAT 600</title>
        ...
        <div class="wrapper">
          ...
          <div class="page-item">
            <div class="page-item__top">
              <div class="page-item__top-left">
                <div class="page-item__image-big  page-item__image-big--arch">
                  <img class="item-img-big" src="img/globalstar_telit_sat600_tecckom.png">
                </div>
                <div class="page-item__image-small">
                  <div class="page-item__image-small-item  page-item__image-small-item--1">   <img class="item-img-small1" src="img/globalstar_telit_sat600_tecckom.png">
                  </div>
                  <div class="page-item__image-small-item  page-item__image-small-item--2">   <img class="item-img-small2" src="img/globalstar_telit_sat600_tecckom.png">
                  </div>
                  <div class="page-item__image-small-item  page-item__image-small-item--3">   <img class="item-img-small3" src="img/globalstar_telit_sat600_tecckom.png">
                  </div>
                </div>
              </div>
              <div class="page-item__top-right">
                <h3 class="page-item__title-category">Спутниковые телефоны Globalstar</h3>
                <h2 class="page-item__title">Telit SAT 600</h2>
                <p class="page-item__description">Двухмодовый телефон Telit SAT 600 отличается легкостью использования как в режиме GSM, так и в режиме Глобалстар.</p>
            ...
            <div class="page-item__info">
              <p><b>Режимы:</b></p>
              <ul>
                <li>двухмодовый Глобалстар/GSM (900 МГц).</li>
                <li>Возможно использовать как обычный одномодовый сотовый телефон с SIM картой Глобалтел или любого оператора GSM.</li>
              </ul>
              <p><b>Текущие услуги:</b></p>
              <ol>
                <li>телефонная связь в режиме Глобалстар и в режиме GSM900;</li>
                <li>сeрвис коротких сообщений (SMS);</li>
                <li>Передача данных 9.6 кбит/с в режиме Глобалстар и GSM-900</li>
                <li>Определение местоположения и других параметров с помощью АТ-команд через интерфейс RS232</li>
              </ol>
              <p><b>Перечень услуг:</b></p>
              <p>телефония, асинхронная передача данных Глобалстар/GSM-900, определение координат, переадресация вызовов, запрет вызовов, определитель/антиопределителеь номера, SMS, "мобильный интернет", служба АССА, голосовая почта, электронная почта домена GTEL.Ru, факс-шлюз, FTP сервер.</p>
              <p><b>Роуминг:</b> Международный в режиме Глобалстар и GSM-900.</p>
