...
<html lang="ru">
  <head>
    <meta charset="utf-8">
    <title>Карта покрытия Турайя</title>
    ...
    <main>
      <div class="page-main  page-main--in">
        <div class="wrapper">
          ...
          <div class="catalog">
            <h2 class="h2-title  h2-title--in"><a>Карта покрытия Турайя</a></h2>
            <div class="article">
              <p><img src="http://www.tecckom.ru/images/thuraya/cover-04_08.jpg"></p>
              <p>Для более устойчивой связи необходимо, чтобы угол видимости спутника Турая был не менее 20 градусов. Thuraya Sattelite Telecommunications Company гарантируют качественную связь в системе Турая при видимости спутника не меньше 20 градусов. При видимости спутника меньше 20 градусов сигнал Турая может быть, но качество связи уже не гарантированное.</p>
            </div>
          </div>
        </div>
      </div>
