...
<html lang="ru">
  <head>
    <meta charset="utf-8">
    <title>Спутниковый телефон Iridium 9505А</title>
        ...
        <div class="wrapper">
          ...
          <div class="page-item">
            <div class="page-item__top">
              <div class="page-item__top-left">
                <div class="page-item__image-big  page-item__image-big--arch">
                  <img class="item-img-big" src="img/iridium9505a.jpg">
                </div>
                <div class="page-item__image-small">
                  <div class="page-item__image-small-item  page-item__image-small-item--1">   <img class="item-img-small1" src="img/iridium9505a.jpg">
                  </div>
                  <div class="page-item__image-small-item  page-item__image-small-item--2">   <img class="item-img-small2" src="img/iridium9505a-2.jpg">
                  </div>
                  <div class="page-item__image-small-item  page-item__image-small-item--3">   <img class="item-img-small3" src="img/iridium9505a-3.jpg">
                  </div>
                </div>
              </div>
              <div class="page-item__top-right">
                <h3 class="page-item__title-category">Спутниковые телефоны Iridium</h3>
                <h2 class="page-item__title">Iridium 9505А</h2>
                <p class="page-item__description">Пыле влагозащищенный, противоударный корпус позволяет использовать терминал в тяжелых условиях. Понятный, интуитивный интерфейс.</p>
            ...
            <div class="page-item__info">
              <p>9505А. Пыле влагозащищенный, противоударный корпус позволяет использовать терминал в тяжелых условиях. Понятный, интуитивный интерфейс. Возможность использовать телефон для приема и передачи данных со скоростью 9,6 Кб/сек через RS232 адаптер. Русифицированное меню и возможность выбора из 21 языка.</p>
              <ul>
                <li>Монохромный графический Ж/К дисплей, 4 линии, 16 знаков.</li>
                <li>Регулировка яркости дисплея.</li>
                <li>Отображение и сигнализации уровня заряда аккумулятора.</li>
                <li>Отображение уровня принимаемого сигнала.</li>
                <li>Переадресация и запрет вызова.</li>
                <li>Почтовый ящик SMS 160 знаков.</li>
                <li>Выбор тона звонка - 10, вибровызов.</li>
                <li>Индикация не принятых вызовов.</li>
                <li>Телефонная книжка на 100 номеров.</li>
                <li>Память на 10 последних набранных номеров.</li>
                <li>Регистрация звонков и их длительности.</li>
                <li>Габариты: 158 мм Х 62 мм Х 59 мм. Вес: 375 г</li>
                <li>Частотный диапазон 1616-1626.5 MHz, L-band</li>
                <li>Метод кодирования  TDMA/FDMA</li>
                <li>Излучаемая мощность: 0.57 W</li>
                <li>Температуры использования: от - 20° до + 60°</li>
              </ul>
            </div>
          </div>
        </div>
