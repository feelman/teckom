...
<html lang="ru">
  <head>
    <meta charset="utf-8">
    <title>Спутниковые телефоны</title>
    ...
    <main>
      <div class="page-main  page-main--in">
        <div class="wrapper">
          ...
          <div class="catalog">
            <h2 class="h2-title  h2-title--in"><a>Спутниковые телефоны</a></h2>
            <div class="catalog__list">
              <div class="catalog__list-top">
                <div class="catalog__list-logo">
                  ...
                  <div class="catalog__list-logo-url"><a href="iridium_about.php">О системе</a></div>
                </div>
            ...
            <div class="catalog__list">
              <div class="catalog__list-top">
                <div class="catalog__list-logo">
                  <div class="catalog__list-logo-img"><img src="img/logo-globalstar.png"></div>
                  <div class="catalog__list-logo-url"><a href="globalstar_features.php">О системе</a></div>
                </div>
                <h4 class="h4-title  h4-title--globalstar">Спутниковые телефоны Globalstar</h4>
              </div>
              <div class="catalog__list-main">
                <div class="catalog-item">
                  <a href="globalstar_qualcomm-gsp1600.php">
                    ...
                    <div class="catalog__item-footer">
                      <div class="catalog__item-price">41 498Р</div>
                      <div class="catalog__item-cart"><a href="#"><img src="img/incart.png"></a></div>
                    </div>
                  </a>
                </div>
                <div class="catalog-item">
                  <a href="globalstar_qualcomm-gsp1700.php">
                    <div class="catalog__item-img"><img src="img/qual-1700.jpg"></div>
                    <h5 class="catalog__item-title">Qualcomm GSP 1700</h5>
                    <div class="catalog__item-info">Самый компактный в семействе спутниковых мобильных телефонов</div>
                    <div class="catalog__item-footer">
                      <div class="catalog__item-price">39 999Р</div>
                      <div class="catalog__item-cart"><a href="#"><img src="img/incart.png"></a></div>
                    </div>
                  </a>
                </div>
            ...
            <div class="catalog__list">
              <div class="catalog__list-top">
                <div class="catalog__list-logo">
                  ...
                  <div class="catalog__list-logo-url"><a href="thuraya_about.php">О системе</a></div>
                </div>
...
Android</h5>
            ...
            <div class="catalog__list">
              <div class="catalog__list-top">
                <div class="catalog__list-logo">
                  <div class="catalog__list-logo-img"><img src="img/logo-inmarsat.png"></div>
                  <div class="catalog__list-logo-url"><a href="inmarsat_bgan.php">О системе</a></div>
                </div>
                <h4 class="h4-title  h4-title--inmarsat">Спутниковые телефоны inmarsat</h4>
              </div>
              <div class="catalog__list-main">
                <div class="catalog-item">
                  <a href="inmarsat_index.php ">
                    <div class="catalog__item-img"><img src="img/isatphone2.jpg"></div>
                    <h5 class="catalog__item-title">IsatPhone 2</h5>
                    <div class="catalog__item-info">От жгучей жары до суровых морозов; пустынные песчаные бури.</div>
                    <div class="catalog__item-footer">
                      <div class="catalog__item-price">49 000Р</div>
                      <div class="catalog__item-cart"><a href="#"><img src="img/incart.png"></a></div>
                    </div>
