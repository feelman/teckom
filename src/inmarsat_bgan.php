...
<html lang="ru">
  <head>
    <meta charset="utf-8">
    <title>Спутниковая связь Inmarsat</title>
        ...
        <div class="wrapper">
          <div class="page-main__top">
            <div class="breadcrumbs">
              ...
              <span>>></span>
              <a>Телефоны спутниковой связи Inmarsat</a>
            </div>
            <div class="cart">
          ...
          <div class="catalog">
            <h2 class="h2-title  h2-title--in"><a>Спутниковая связь Inmarsat</a></h2>
            <div class="catalog__list">
              ...
              <div class="catalog__list-top-descr"><p>10 марта 2005 года был выведен на орбиту первый из трех запланированных к запуску, спутник Инмарсат 4 поколения. Развертывание на основе спутников 4 поколения Инмарсат, услуг BGAN (Broadband Global Area Network), является логическим продолжением развития системы Инмарсат. Новая система BGAN предлагает более совершенный доступ к современным услугам передачи данных, телефонии, Интернет.</p></div>
